...
DECLARE_LEVEL_SEGMENT(cutscene_0)
DECLARE_LEVEL_SEGMENT(cutscene_1)
DECLARE_LEVEL_SEGMENT(cutscene_2)
DECLARE_LEVEL_SEGMENT(cutscene_3)
DECLARE_LEVEL_SEGMENT(cutscene_4)
DECLARE_LEVEL_SEGMENT(cutscene_5)
DECLARE_LEVEL_SEGMENT(cutscene_6)
DECLARE_LEVEL_SEGMENT(cutscene_7)
