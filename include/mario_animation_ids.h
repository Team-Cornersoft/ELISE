...
enum MarioAnimID {
    ...
    /* 0xC4 */ MARIO_ANIM_IDLE_HEAD_RIGHT = MARIO_ANIM_IDLE_HEAD_LEFT,
    /* 0xC5 */ MARIO_ANIM_IDLE_HEAD_CENTER = MARIO_ANIM_IDLE_HEAD_LEFT,
    /* 0xC6 */ MARIO_ANIM_HANDSTAND_LEFT = 0xC6,
