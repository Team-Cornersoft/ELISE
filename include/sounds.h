...
#define SOUND_ELVOICE_CUTSCENE_SC2_CD0           SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x1F, 0xF0, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
#define SOUND_ELVOICE_CUTSCENE_SC2_CD1           SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x20, 0xF0, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
#define SOUND_ELVOICE_CUTSCENE_SC2_CD2           SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x21, 0xF0, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
#define SOUND_ELVOICE_CUTSCENE_SC2_CD3           SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x22, 0xF0, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
#define SOUND_ELVOICE_CUTSCENE_SC2_CD4           SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x23, 0xF0, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
#define SOUND_ELVOICE_CUTSCENE_SC2_CD5           SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x24, 0xF0, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
#define SOUND_ELVOICE_CUTSCENE_SC2_CD6           SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x25, 0xF0, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
