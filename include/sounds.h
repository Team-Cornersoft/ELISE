...
#define SOUND_ACTION_CUSTOM_TELEPORT             /* 0x0457C080 */ SOUND_ARG_LOAD(SOUND_BANK_ACTION,   0x70, 0xC0, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
...
#define SOUND_CUSTOM_STEREO_RAIN                 SOUND_ARG_LOAD(SOUND_BANK_CONT_ENV,     0x00, 0x40, SOUND_NO_VOLUME_LOSS | SOUND_NO_PRIORITY_LOSS | SOUND_CONSTANT_FREQUENCY)


#define SOUND_ELVOICE_DESPAIR_GRUNT_0            SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x00, 0x40, SOUND_DISCRETE)
#define SOUND_ELVOICE_DESPAIR_GRUNT_1            SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x01, 0x40, SOUND_DISCRETE)
#define SOUND_ELVOICE_DESPAIR_GRUNT_2            SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x02, 0x40, SOUND_DISCRETE)
#define SOUND_ELVOICE_DESPAIR_GRUNT_3            SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x03, 0x40, SOUND_DISCRETE)
#define SOUND_ELVOICE_DESPAIR_GRUNT_4            SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x04, 0x40, SOUND_DISCRETE)
#define SOUND_ELVOICE_DESPAIR_GRUNT_5            SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x05, 0x40, SOUND_DISCRETE)
#define SOUND_ELVOICE_DESPAIR_GRUNT_6            SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x06, 0x40, SOUND_DISCRETE)
#define SOUND_ELVOICE_DESPAIR_GRUNT_7            SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x07, 0x40, SOUND_DISCRETE)
#define SOUND_ELVOICE_DESPAIR_GRUNT_8            SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x08, 0x40, SOUND_DISCRETE)
#define SOUND_ELVOICE_DESPAIR_GRUNT_9            SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x09, 0x40, SOUND_DISCRETE)
#define SOUND_ELVOICE_DESPAIR_ELISE_DEATH        SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x0A, 0x80, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
#define SOUND_ELVOICE_DESPAIR_DEATH_BLUE         SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x0B, 0xF0, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
#define SOUND_ELVOICE_DESPAIR_DEATH_RED          SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x0C, 0xF0, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
#define SOUND_ELVOICE_CUTSCENE_SC0_CD0           SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x0D, 0xF0, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
#define SOUND_ELVOICE_CUTSCENE_SC0_CD1           SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x0E, 0xF0, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
#define SOUND_ELVOICE_CUTSCENE_SC0_CD2           SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x0F, 0xF0, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
#define SOUND_ELVOICE_CUTSCENE_SC0_CD3           SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x10, 0xF0, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
#define SOUND_ELVOICE_CUTSCENE_SC0_CD4           SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x11, 0xF0, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
#define SOUND_ELVOICE_CUTSCENE_SC0_CD5           SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x12, 0xF0, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
#define SOUND_ELVOICE_CUTSCENE_SC0_CD6           SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x13, 0xF0, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
#define SOUND_ELVOICE_CUTSCENE_SC1_CD0           SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x14, 0xF0, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
#define SOUND_ELVOICE_CUTSCENE_SC1_CD1           SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x15, 0xF0, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
#define SOUND_ELVOICE_CUTSCENE_SC1_CD2           SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x16, 0xF0, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
#define SOUND_ELVOICE_CUTSCENE_SC1_CD3           SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x17, 0xF0, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
#define SOUND_ELVOICE_CUTSCENE_SC1_CD4           SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x18, 0xF0, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
#define SOUND_ELVOICE_CUTSCENE_SC1_CD5           SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x19, 0xF0, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
#define SOUND_ELVOICE_CUTSCENE_SC1_CD6           SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x1A, 0xF0, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
#define SOUND_ELVOICE_CUTSCENE_SC1_CD7           SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x1B, 0xF0, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
#define SOUND_ELVOICE_CUTSCENE_SC1_CD8           SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x1C, 0xF0, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
#define SOUND_ELVOICE_CUTSCENE_SC1_CD9           SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x1D, 0xF0, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
#define SOUND_ELVOICE_CUTSCENE_SC1_CDA           SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x1E, 0xF0, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
#define SOUND_ELVOICE_CUTSCENE_SC2_CD1           SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x1F, 0xF0, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
#define SOUND_ELVOICE_CUTSCENE_SC2_CD2           SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x20, 0xF0, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
#define SOUND_ELVOICE_CUTSCENE_SC2_CD3           SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x21, 0xF0, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
#define SOUND_ELVOICE_CUTSCENE_SC2_CD4           SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x22, 0xF0, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
#define SOUND_ELVOICE_CUTSCENE_SC2_CD5           SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x23, 0xF0, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
#define SOUND_ELVOICE_CUTSCENE_SC2_CD6           SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x24, 0xF0, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
#define SOUND_ELVOICE_CUTSCENE_SC2_CD7           SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x25, 0xF0, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
#define SOUND_ELVOICE_DESPAIR_LAUGH_0            SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x26, 0x60, SOUND_DISCRETE)
#define SOUND_ELVOICE_DESPAIR_LAUGH_1            SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x27, 0x60, SOUND_DISCRETE)
#define SOUND_ELVOICE_DESPAIR_LAUGH_2            SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x28, 0x60, SOUND_DISCRETE)
#define SOUND_ELVOICE_DESPAIR_LAUGH_3            SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x29, 0x60, SOUND_DISCRETE)
#define SOUND_ELVOICE_DESPAIR_LAUGH_4            SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x2A, 0x60, SOUND_DISCRETE)
#define SOUND_ELVOICE_EL_GRUNT_DISGUST           SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x2B, 0x60, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
#define SOUND_ELVOICE_EL_GRUNT_MMM               SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x2C, 0x60, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
#define SOUND_ELVOICE_EL_GRUNT_HUH_CONFUSED      SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x2D, 0x60, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
#define SOUND_ELVOICE_EL_GRUNT_HUH_EXCITED       SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x2E, 0x60, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
#define SOUND_ELVOICE_EL_GRUNT_AWW               SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x2F, 0x60, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
#define SOUND_ELVOICE_EL_DIA_WHATS_IN_HERE       SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x30, 0x60, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
#define SOUND_ELVOICE_EL_DIA_HAHA_VERY_FUNNY     SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x31, 0x60, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
#define SOUND_ELVOICE_EL_DIA_NOW_THIS_COOL       SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x32, 0x60, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
#define SOUND_ELVOICE_EL_DIA_MOM_WOULDA_LOVED    SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x33, 0x60, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
#define SOUND_ELVOICE_EL_DIA_OH_A_SECRET         SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x34, 0x60, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
#define SOUND_ELVOICE_EL_DIA_WHY_SUBC_TEARDROPS  SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x35, 0x60, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
#define SOUND_ELVOICE_EL_DIA_LEAVES_MIND_WANDER  SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x36, 0x60, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
#define SOUND_ELVOICE_EL_DIA_WONDER_IF_MORE      SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x37, 0x60, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
#define SOUND_ELVOICE_EL_DIA_ROOM_PRETTY         SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x38, 0x60, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
#define SOUND_ELVOICE_EL_DIA_LOVELY              SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x39, 0x60, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
#define SOUND_ELVOICE_EL_DIA_WHY_THIS_IN_HEAD    SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x3A, 0x60, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
#define SOUND_ELVOICE_EL_DIA_HEAD_PLAYING_TRICKS SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x3B, 0x60, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
#define SOUND_ELVOICE_EL_DIA_WHERE_LEAD_TO       SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x3C, 0x60, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
#define SOUND_ELVOICE_EL_DIA_HMM_INTERESTING     SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x3D, 0x60, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
