...
#define SOUND_CUSTOM_STEREO_RAIN_DELETE          SOUND_ARG_LOAD(SOUND_BANK_ELISE_VOICES, 0x00, 0x40, SOUND_NO_VOLUME_LOSS | SOUND_NO_PRIORITY_LOSS | SOUND_CONSTANT_FREQUENCY)
