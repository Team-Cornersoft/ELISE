...
#define MODEL_MAIN_MENU_BACKGROUND_GREEN          MODEL_LEVEL_GEOMETRY_0D   // main_menu_geo_0002E0
#define MODEL_MAIN_MENU_BACKGROUND_BLUE           MODEL_LEVEL_GEOMETRY_0E
#define MODEL_MAIN_MENU_BACKGROUND_RED            MODEL_LEVEL_GEOMETRY_0F
