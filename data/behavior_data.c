...
const BehaviorScript bhvPortalWarp[] = {
    BEGIN(OBJ_LIST_SURFACE),
    ...
    SET_HOME(),
    SET_FLOAT(oDrawingDistance, 20000),
    CALL_NATIVE(bhv_portal_warp_init),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_portal_warp_loop),
        CALL_NATIVE(load_object_collision_model),
    END_LOOP(),
};

const BehaviorScript bhvBossPortalWarp[] = {
    BEGIN(OBJ_LIST_SURFACE),
    LOAD_COLLISION_DATA(custom_boss_portal_collision),
    OR_INT(oFlags, (OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_INT(oInteractType, INTERACT_WARP),
    SET_INT(oIntangibleTimer, 0),
    SET_HOME(),
    SET_FLOAT(oDrawingDistance, 20000),
    CALL_NATIVE(bhv_boss_portal_warp_init),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_boss_portal_warp_loop),
        CALL_NATIVE(load_object_collision_model),
    END_LOOP(),
};
...
const BehaviorScript bhvUkikiCage[] = {
    ...
    SPAWN_CHILD(/*Model*/ MODEL_DREAM_DROP_BLUE, /*Behavior*/ bhvUkikiCageStar),
...
const BehaviorScript bhvBooCage[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_INT(oAction, BOO_CAGE_ACT_ON_GROUND),
...
const BehaviorScript bhvMenuButtonManager[] = {
    ...
    CALL_NATIVE(bhv_file_select_manager_init),
    BEGIN_LOOP(),
        SET_INT(oIntangibleTimer, 0),
        CALL_NATIVE(bhv_file_select_manager_loop),
    END_LOOP(),
};
