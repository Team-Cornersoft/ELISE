...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT(MODEL_NONE, -3465, 0, -3465, 0, 45, 0, 0x50020000, bhvNoseman),
		OBJECT(MODEL_NONE, -2702, 0, -7424, 0, 20, 0, 0x50030000, bhvNoseman),
		OBJECT(MODEL_NONE, 3728, 0, -10243, 0, -20, 0, 0x50050000, bhvNoseman),
		OBJECT(MODEL_NONE, 3465, 0, -3465, 0, -45, 0, 0x50060000, bhvNoseman),
		OBJECT(MODEL_NONE, 7424, 0, -2702, 0, -70, 0, 0x50070000, bhvNoseman),
		OBJECT(MODEL_NONE, 10243, 0, 3728, 0, -110, 0, 0x50080000, bhvNoseman),
		OBJECT(MODEL_NONE, 3465, 0, 3465, 0, -135, 0, 0x50090000, bhvNoseman),
		OBJECT(MODEL_NONE, 2702, 0, 7424, 0, -160, 0, 0x500A0000, bhvNoseman),
		OBJECT(MODEL_NONE, -3728, 0, 10243, 0, 160, 0, 0x500B0000, bhvNoseman),
		OBJECT(MODEL_NONE, -3465, 0, 3465, 0, 135, 0, 0x500C0000, bhvNoseman),
		OBJECT(MODEL_NONE, -7424, 0, 2702, 0, 110, 0, 0x500D0000, bhvNoseman),
		OBJECT(MODEL_NONE, -10243, 0, -3728, 0, 70, 0, 0x500E0000, bhvNoseman),
		...
		OBJECT(MODEL_NONE, -17, 698, -1, 0, 0, 0, 0x06CC0000, bhvWarp),
	...
	AREA(2, bob_area_2),
		...
		OBJECT(MODEL_NONE, -17, 698, -1, 0, 0, 0, 0x06CB0000, bhvWarp),
		TERRAIN(bob_area_2_collision),
		MACRO_OBJECTS(bob_area_2_macro_objs),
		STOP_MUSIC(0),
		TERRAIN_TYPE(TERRAIN_GRASS),
		/* Fast64 begin persistent block [area commands] */
		SET_BACKGROUND_MUSIC_WITH_REVERB(0x00, SEQ_LEVEL_CHIMES, 0x01, 0x02),
		SET_ECHO(0x80, 0x80),
		/* Fast64 end persistent block [area commands] */
	END_AREA(),
