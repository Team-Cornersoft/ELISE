...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		WARP_NODE(0xBA, LEVEL_WF, 0x01, 0x0BA, WARP_NO_CHECKPOINT),
		WARP_NODE(0xBB, LEVEL_WF, 0x01, 0xBB, WARP_NO_CHECKPOINT),
		WARP_NODE(0xCA, LEVEL_BOB, 0x01, 0xBB, WARP_NO_CHECKPOINT),
		WARP_NODE(0xCB, LEVEL_CASTLE, 0x01, 0xBA, WARP_NO_CHECKPOINT),
	...
	AREA(2, wf_area_2),
		...
		INSTANT_WARP(0x00, 0x02, 0, 10300, 33300),
		INSTANT_WARP(0x01, 0x02, 89, 6024, 17439),
		INSTANT_WARP(0x02, 0x01, -5000, 5900, 17000),
		INSTANT_WARP(0x03, 0x01, 4985, 6013, 17453),
		OBJECT(MODEL_NONE, 907, 3921, 28456, 0, -180, 0, 0x00BA0000, bhvSpinAirborneWarp),
		OBJECT(MODEL_NONE, 6007, -5023, -6997, 0, 135, 0, 0xFFCA0000, bhvWarp),
		OBJECT(MODEL_STAR, 968, -3885, -28147, 0, -180, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_PORTAL_WARP, -1988, -4233, -29845, 0, -180, 0, 0x00CB0100, bhvPortalWarp),
