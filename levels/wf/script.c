...
const LevelScript level_wf_entry[] = {
	...
	AREA(2, wf_area_2),
		...
		OBJECT(MODEL_NONE, -28116, 10303, -28116, 0, 45, 0, 0x00BA0000, bhvSpinAirborneWarp),
		OBJECT(MODEL_NONE, -17082, 5684, -12971, 0, 0, 0, 0x30CA0000, bhvWarp),
		OBJECT(MODEL_STAR, 29104, -9610, 29096, 0, 45, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_PORTAL_WARP, 32404, -9910, 28196, 0, 45, 0, 0x00CB0100, bhvPortalWarp),
