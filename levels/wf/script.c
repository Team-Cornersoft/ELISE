...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		WARP_NODE(0xCB, LEVEL_BOB, 0x01, 0xBA, WARP_NO_CHECKPOINT),
		WARP_NODE(0xCC, LEVEL_WF, 0x02, 0xBA, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_NONE, 0, 0, 8500, 0, -180, 0, 0x00BA0000, bhvSpinAirborneWarp),
		OBJECT(MODEL_NONE, 0, 0, -8500, 0, 0, 0, 0x00BB0000, bhvSpinAirborneWarp),
		...
		OBJECT(MODEL_PORTAL_WARP, 0, -10, -9600, 0, 0, 0, 0x00CB0100, bhvPortalWarp),
		OBJECT(MODEL_NONE, 0, 0, 0, 0, 0, 0, 0x05CC0000, bhvWarp),
	...
	AREA(2, wf_area_2),
		...
		OBJECT(MODEL_NONE, 31407, 11121, 29056, 0, -180, 0, 0x00BA0000, bhvSpinAirborneWarp),
		OBJECT(MODEL_NONE, -30853, 11161, 29056, 0, -180, 0, 0x00BB0000, bhvSpinAirborneWarp),
		OBJECT(MODEL_NONE, 977, -319, -6354, 0, -180, 0, 0x00BC0000, bhvSpinAirborneWarp),
		...
		OBJECT(MODEL_STAR, 968, -4085, -28547, 0, -180, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_PORTAL_WARP, -1988, -4233, -29845, 0, 90, 0, 0x00CA0100, bhvPortalWarp),
