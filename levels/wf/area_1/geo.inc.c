...
const GeoLayout wf_area_1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 0, 190, -9600, wf_dl_C_Portal_000_mesh_layer_1),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_TRANSPARENT, wf_dl_C_Portal_000_mesh_layer_5),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 0, 190, 9600, wf_dl_C_Portal_001_mesh_layer_1),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_TRANSPARENT, wf_dl_C_Portal_001_mesh_layer_5),
		GEO_CLOSE_NODE(),
		GEO_ROTATION_NODE_WITH_DL(LAYER_TRANSPARENT, 0, -180, 0, wf_dl_Z_Water_A_mesh_layer_5),
		GEO_ROTATION_NODE_WITH_DL(LAYER_TRANSPARENT, 0, -180, 0, wf_dl_Z_Water_B_mesh_layer_5),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
