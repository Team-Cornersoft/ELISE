...
const LevelScript level_cutscene_scene_1_2[] = {
    ...
    CLEAR_LEVEL(),
    SLEEP(/*frames*/ 20),
    EXIT_AND_EXECUTE_WITH_CODE(/*seg*/ SEGMENT_MENU_INTRO, _cutscene_1SegmentRomStart, _cutscene_1SegmentRomEnd, level_cutscene_scene_1_3, _cutscene_1SegmentBssStart, _cutscene_1SegmentBssEnd),
};
