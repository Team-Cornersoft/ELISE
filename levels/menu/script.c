...
const LevelScript level_main_menu_entry_file_select[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_MAIN_MENU_BACKGROUND_GREEN,       geo_menu_background_green),
    LOAD_MODEL_FROM_GEO(MODEL_MAIN_MENU_BACKGROUND_BLUE,        geo_menu_background_blue),
    LOAD_MODEL_FROM_GEO(MODEL_MAIN_MENU_BACKGROUND_RED,         geo_menu_background_red),
    ...
    AREA(/*index*/ 1, geo_menu_file_select_strings_and_menu_cursor),
        OBJECT(/*model*/ MODEL_NONE,                         /*pos*/ 0, 0, -18900, /*angle*/ 0, 0, 0, /*behParam*/ BP(0x04, 0x00, 0x00, 0x00), /*beh*/ bhvMenuButtonManager),
    ...
    FREE_LEVEL_POOL(),
    LOAD_AREA(/*area*/ 1),
    // SET_MENU_MUSIC_WITH_REVERB(/*seq*/ SEQ_MENU_FILE_SELECT, 0x01, 0x02),
