...
const GeoLayout geo_menu_mario_save_button[] = {
   GEO_NODE_START(),
   GEO_OPEN_NODE(),
      GEO_SCALE(0x00, 1572864),
      GEO_OPEN_NODE(),
         GEO_DISPLAY_LIST(LAYER_TRANSPARENT, bloomed_menu_button_MenuButton_001_mesh),
...
const GeoLayout geo_menu_mario_new_button[] = {
   ...
   GEO_OPEN_NODE(),
      GEO_SCALE(0x00, 1572864),
      GEO_OPEN_NODE(),
         GEO_DISPLAY_LIST(LAYER_TRANSPARENT, menu_button_custom_MenuButton_mesh),
...
const GeoLayout geo_menu_copy_button[] = {
   ...
   GEO_OPEN_NODE(),
      GEO_SCALE(0x00, 1572864),
      GEO_OPEN_NODE(),
         GEO_DISPLAY_LIST(LAYER_TRANSPARENT, blank_menu_button_BlankButton_mesh),
      GEO_CLOSE_NODE(),
   GEO_CLOSE_NODE(),
   GEO_END(),
};
...
const GeoLayout geo_menu_background_green[] = {
   GEO_NODE_START(),
   GEO_OPEN_NODE(),
      GEO_SCALE(0x00, 524288),
      GEO_OPEN_NODE(),
         GEO_DISPLAY_LIST(LAYER_OPAQUE, background_green_BackgroundGreen_mesh),
      GEO_CLOSE_NODE(),
   GEO_CLOSE_NODE(),
   GEO_END(),
};
const GeoLayout geo_menu_background_blue[] = {
   GEO_NODE_START(),
   GEO_OPEN_NODE(),
      GEO_SCALE(0x00, 524288),
      GEO_OPEN_NODE(),
         GEO_DISPLAY_LIST(LAYER_OPAQUE, background_blue_BackgroundBlue_mesh),
      GEO_CLOSE_NODE(),
   GEO_CLOSE_NODE(),
   GEO_END(),
};
const GeoLayout geo_menu_background_red[] = {
   GEO_NODE_START(),
   GEO_OPEN_NODE(),
      GEO_SCALE(0x00, 524288),
      GEO_OPEN_NODE(),
         GEO_DISPLAY_LIST(LAYER_OPAQUE, background_red_BackgroundRed_mesh),
      GEO_CLOSE_NODE(),
   GEO_CLOSE_NODE(),
   GEO_END(),
};
