...
const LevelScript level_castle_inside_entry[] = {
	...
	AREA(1, castle_inside_area_1),
		...
		WARP_NODE(0xCC, LEVEL_CASTLE, 0x01, 0xBC, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_NONE, 0, 0, -2100, 0, 0, 0, 0x00BA0000, bhvSpinAirborneWarp),
		OBJECT(MODEL_NONE, -1850, 0, 1260, 0, 120, 0, 0x00BB0000, bhvSpinAirborneWarp),
		OBJECT(MODEL_NONE, 1850, 0, 1260, 0, -120, 0, 0x00BC0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, 0, 0, 200, 0),
		OBJECT(MODEL_NONE, 0, 0, 1500, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		OBJECT(MODEL_NONE, 0, 0, -3200, 0, -180, 0, 0x00CA0000, bhvWarp),
		OBJECT(MODEL_NONE, 2805, 0, 1803, 0, -120, 0, 0x00CB0000, bhvWarp),
		OBJECT(MODEL_NONE, -2801, 0, 1806, 0, 120, 0, 0x00CC0000, bhvWarp),
