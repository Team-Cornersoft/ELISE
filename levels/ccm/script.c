...
const LevelScript level_ccm_entry[] = {
	...
	AREA(2, ccm_area_2),
		...
		WARP_NODE(0xCB, LEVEL_CCM, 0x05, 0xBA, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_CUSTOM_DOOR_A, 2000, 0, -700, 0, 0, 0, 0x00DC0000, bhvDoorWarp),
		OBJECT(MODEL_NONE, -556, 1000, -1052, 0, 0, 0, 0x01000000, bhvStar),
		...
		OBJECT(MODEL_NONE, 2380, 645, -1150, 0, 0, 0, 0x10CB0000, bhvWarp),
		OBJECT(MODEL_NONE, -1550, 0, -1200, 0, 0, 0, 0x10CA0000, bhvWarp),
