...
const LevelScript level_ccm_entry[] = {
	...
	AREA(1, ccm_area_1),
		...
		WARP_NODE(0xDA, LEVEL_CASTLE, 0x01, 0xBB, WARP_NO_CHECKPOINT),
		...
		WARP_NODE(0xD0, LEVEL_BOB, 0x01, 0xD0, WARP_NO_CHECKPOINT),
		...
		OBJECT(MODEL_CCM_CABIN_DOOR, -310, 0, 2050, 0, 90, 0, 0x00DA0000, bhvDoorWarp),
		OBJECT(MODEL_CCM_CABIN_DOOR, -310, 0, 1550, 0, 90, 0, 0x00DB0000, bhvDoorWarp),
		OBJECT(MODEL_CCM_CABIN_DOOR, -310, 0, 1050, 0, 90, 0, 0x00DC0000, bhvDoorWarp),
		OBJECT(MODEL_CCM_CABIN_DOOR, -310, 0, 550, 0, 90, 0, 0x00DD0000, bhvDoorWarp),
		OBJECT(MODEL_CCM_CABIN_DOOR, 150, 0, 90, 0, 0, 0, 0x00DE0000, bhvDoorWarp),
		OBJECT(MODEL_CCM_CABIN_DOOR, 650, -700, 90, 0, 0, 0, 0x00DF0000, bhvDoorWarp),
		OBJECT(MODEL_CCM_CABIN_DOOR, 1150, 0, 90, 0, 0, 0, 0x00D00000, bhvDoorWarp),
		OBJECT(MODEL_CCM_CABIN_DOOR, 1650, 0, 90, 0, 0, 0, 0x00D10000, bhvDoorWarp),
		OBJECT(MODEL_CCM_CABIN_DOOR, 2110, 0, 275, 0, -90, 0, 0x00D20000, bhvDoorWarp),
