...
const LevelScript level_ccm_entry[] = {
	...
	AREA(1, ccm_area_1),
		...
		WARP_NODE(0xDF, LEVEL_JRB, 0x04, 0xDA, WARP_NO_CHECKPOINT),
		WARP_NODE(0xD0, LEVEL_WF, 0x03, 0xDA, WARP_NO_CHECKPOINT),
		WARP_NODE(0xD1, LEVEL_CCM, 0x02, 0xDC, WARP_NO_CHECKPOINT),
		WARP_NODE(0xD2, LEVEL_TTM, 0x01, 0xBA, WARP_NO_CHECKPOINT),
		...
		WARP_NODE(0xEB, LEVEL_JRB, 0x02, 0xDA, WARP_NO_CHECKPOINT),
		WARP_NODE(0xCA, LEVEL_TTM, 0x03, 0xBA, WARP_NO_CHECKPOINT),
		...
		OBJECT(MODEL_NONE, -4115, 0, -1950, 0, 90, 0, 0x08CA0000, bhvWarp),
	...
	AREA(2, ccm_area_2),
		...
		OBJECT(MODEL_NONE, 5200, 0, -3490, 0, 0, 0, 0xB4130000, bhvNoseman),
		OBJECT(MODEL_NONE, 0, 0, -3490, 0, 0, 0, 0xB4110000, bhvNoseman),
		OBJECT(MODEL_NONE, -5105, 0, -3492, 0, 0, 0, 0xB4120000, bhvNoseman),
		OBJECT(MODEL_NONE, 0, 0, -1000, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		OBJECT(MODEL_NONE, 5510, 445, -1271, 0, -150, 0, 0x00CB0000, bhvWarp),
	...
	AREA(4, ccm_area_4),
		...
		OBJECT(MODEL_NONE, 1035, -300, 4495, 0, 0, 0, 0xB40F0000, bhvNoseman),
	...
	AREA(5, ccm_area_5),
		...
		OBJECT(MODEL_NONE, -7257, 445, -7583, 0, 30, 0, 0x00CA0000, bhvWarp),
	...
	AREA(6, ccm_area_6),
		...
		OBJECT(MODEL_DREAM_DROP_BLUE, 1830, 800, -4299, 0, 0, 0, 0x00000000, bhvStar),
