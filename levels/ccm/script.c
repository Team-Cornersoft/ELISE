...
const LevelScript level_ccm_entry[] = {
	...
	AREA(1, ccm_area_1),
		...
		OBJECT(MODEL_CUSTOM_DOOR_A, -315, 0, 5550, 0, 90, 0, 0x00DA0000, bhvDoorWarp),
		OBJECT(MODEL_CUSTOM_DOOR_A, -315, 0, 4050, 0, 90, 0, 0x00DB0000, bhvDoorWarp),
		OBJECT(MODEL_CUSTOM_DOOR_A, -315, 0, 2550, 0, 90, 0, 0x00DC0000, bhvDoorWarp),
		OBJECT(MODEL_CUSTOM_DOOR_A, -315, 0, 1050, 0, 90, 0, 0x00DD0000, bhvDoorWarp),
		OBJECT(MODEL_CUSTOM_DOOR_A, 150, 0, 85, 0, 0, 0, 0x00DE0000, bhvDoorWarp),
		OBJECT(MODEL_CUSTOM_DOOR_A, 1650, -700, 85, 0, 0, 0, 0x00DF0000, bhvDoorWarp),
		OBJECT(MODEL_CUSTOM_DOOR_A, 3150, 0, 85, 0, 0, 0, 0x00D00000, bhvDoorWarp),
		OBJECT(MODEL_CUSTOM_DOOR_A, 4650, 0, 85, 0, 0, 0, 0x00D10000, bhvDoorWarp),
		OBJECT(MODEL_CUSTOM_DOOR_B, 5615, 0, 275, 0, -90, 0, 0x00D20000, bhvDoorWarp),
		OBJECT(MODEL_CUSTOM_DOOR_B, -125, 0, 6015, 0, 180, 0, 0x00D30000, bhvDoorWarp),
