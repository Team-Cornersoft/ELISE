...
const LevelScript level_ccm_entry[] = {
	...
	AREA(1, ccm_area_1),
		...
		OBJECT(MODEL_CUSTOM_DOOR_A, -315, 0, 2050, 0, 90, 0, 0x00DA0000, bhvDoorWarp),
		OBJECT(MODEL_CUSTOM_DOOR_A, -315, 0, 1550, 0, 90, 0, 0x00DB0000, bhvDoorWarp),
		OBJECT(MODEL_CUSTOM_DOOR_A, -315, 0, 1050, 0, 90, 0, 0x00DC0000, bhvDoorWarp),
		OBJECT(MODEL_CUSTOM_DOOR_A, -315, 0, 550, 0, 90, 0, 0x00DD0000, bhvDoorWarp),
		OBJECT(MODEL_CUSTOM_DOOR_A, 150, 0, 85, 0, 0, 0, 0x00DE0000, bhvDoorWarp),
		OBJECT(MODEL_CUSTOM_DOOR_A, 650, -700, 85, 0, 0, 0, 0x00DF0000, bhvDoorWarp),
		OBJECT(MODEL_CUSTOM_DOOR_A, 1150, 0, 85, 0, 0, 0, 0x00D00000, bhvDoorWarp),
		OBJECT(MODEL_CUSTOM_DOOR_A, 1650, 0, 85, 0, 0, 0, 0x00D10000, bhvDoorWarp),
