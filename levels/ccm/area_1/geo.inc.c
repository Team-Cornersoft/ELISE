...
const GeoLayout ccm_dl_Doors_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -3000, 0, -3000, ccm_dl_A_apartment_door_0_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -3000, 0, -3000, ccm_dl_A_apartment_door_1_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -3000, 0, -3000, ccm_dl_A_apartment_door_2_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -3000, 0, -3000, ccm_dl_A_apartment_door_3_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -3000, 0, -3000, ccm_dl_A_apartment_door_4_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -3000, 0, -3000, ccm_dl_A_apartment_door_5_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -3000, 0, -3000, ccm_dl_A_apartment_door_6_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -3000, 0, -3000, ccm_dl_A_apartment_door_7_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -3000, 0, -3000, ccm_dl_A_apartment_door_8_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -3000, 0, -3000, ccm_dl_A_apartment_door_9_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
