...
const GeoLayout ccm_area_6_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 4000, 800, -1500, 0, -90, 0, ccm_dl_A_room_dino_mesh_layer_1),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_TRANSPARENT, ccm_dl_A_room_dino_mesh_layer_5),
			GEO_DISPLAY_LIST(LAYER_ALPHA, ccm_dl_A_room_dino_mesh_layer_4),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 1403, 109, -3405, ccm_dl_B_dino_deco_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
