...
const LevelScript level_ttm_entry[] = {
	...
	AREA(1, ttm_area_1),
		...
		OBJECT(MODEL_NONE, -3000, -5300, 17671, 0, -180, 0, 0x00BA0000, bhvFadingWarp),
		OBJECT(MODEL_NONE, -3000, -4900, -7812, 0, 0, 0, 0x00BB0000, bhvFadingWarp),
		MARIO_POS(0x01, 0, -3000, -5700, 17671),
		...
		OBJECT(MODEL_RED_COIN, -3000, -6000, 16000, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_NONE, -3000, -5600, -12000, 0, 0, 0, 0x00000000, bhvHiddenRedCoinStar),
		OBJECT(MODEL_NONE, -3000, -5700, 17671, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
	...
	AREA(2, ttm_area_2),
		...
		WARP_NODE(0xBA, LEVEL_TTM, 0x02, 0xBA, WARP_NO_CHECKPOINT),
		WARP_NODE(0xCA, LEVEL_TTM, 0x01, 0xBB, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_NONE, -4, 700, -993, 0, 0, 0, 0x00040000, bhvAnimatedWall),
		OBJECT(MODEL_NONE, 0, 1000, 2500, 0, -180, 0, 0x00BA0000, bhvFadingWarp),
		OBJECT(MODEL_NONE, 0, 600, 0, 0, 0, 0, 0x04000000, bhvStar),
		OBJECT(MODEL_NONE, 0, 500, 2500, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
	...
	AREA(3, ttm_area_3),
		WARP_NODE(0x0A, LEVEL_TTM, 0x03, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xBA, LEVEL_TTM, 0x03, 0xBA, WARP_NO_CHECKPOINT),
		WARP_NODE(0xCA, LEVEL_CCM, 0x01, 0xDD, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_NONE, 0, 10000, 5900, 0, -180, 0, 0x00BA0000, bhvFadingWarp),
		OBJECT(MODEL_NONE, 0, 0, 0, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		OBJECT(MODEL_PORTAL_WARP, 0, 9300, 7195, 0, 0, 0, 0x00CA0000, bhvPortalWarp),
		TERRAIN(ttm_area_3_collision),
		MACRO_OBJECTS(ttm_area_3_macro_objs),
		STOP_MUSIC(0),
		TERRAIN_TYPE(TERRAIN_GRASS),
		/* Fast64 begin persistent block [area commands] */
		SET_BACKGROUND_MUSIC_WITH_REVERB(0x00, SEQ_EVENT_FILE_SELECT, 0x01, 0x02),
		SET_ECHO(0x0E, 0x10),
		/* Fast64 end persistent block [area commands] */
	END_AREA(),
