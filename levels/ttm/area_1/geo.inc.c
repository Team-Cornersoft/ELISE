...
const GeoLayout ttm_area_1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -21262, 2880, -15585, 9, -29, -77, ttm_dl_B_Crystal_Star_012_mesh_layer_1),
		GEO_OPEN_NODE(),
		...
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 7625, 9859, -24424, 130, -46, -22, ttm_dl_B_Crystal_Star_015_mesh_layer_1),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_TRANSPARENT, ttm_dl_B_Crystal_Star_015_mesh_layer_5),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -5318, -2069, 5435, -2, 13, -14, ttm_dl_B_Crystal_Stars_A_mesh_layer_1),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_TRANSPARENT, ttm_dl_B_Crystal_Stars_A_mesh_layer_5),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 3822, -480, -2010, -4, 27, 19, ttm_dl_B_Crystal_Stars_B_mesh_layer_1),
		GEO_OPEN_NODE(),
