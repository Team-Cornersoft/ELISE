...
const LevelScript level_wdw_entry[] = {
	...
	AREA(1, wdw_area_1),
		...
		WARP_NODE(0xBB, LEVEL_WDW, 0x01, 0xBB, WARP_NO_CHECKPOINT),
		WARP_NODE(0xCA, LEVEL_LLL, 0x01, 0xBB, WARP_NO_CHECKPOINT),
		WARP_NODE(0xCB, LEVEL_WDW, 0x02, 0xBA, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_NONE, -1216, 2859, -612, 0, 0, 0, 0x00000000, bhvHiddenRedCoinStar),
		OBJECT(MODEL_NONE, 2, -8479, 3277, 0, -180, 0, 0x00BA0000, bhvFadingWarp),
		OBJECT(MODEL_NONE, -462, 3366, -175, 0, -120, 0, 0x00BB0000, bhvFadingWarp),
		...
		SET_BACKGROUND_MUSIC_WITH_REVERB(0x00, SEQ_LEVEL_MEDICINE, 0x03, 0x04),
		SET_ECHO(0x24, 0x24),
	...
	AREA(2, wdw_area_2),
		...
		WARP_NODE(0xCA, LEVEL_WDW, 0x01, 0xBB, WARP_NO_CHECKPOINT),
