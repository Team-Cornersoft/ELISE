...
const LevelScript level_sl_entry[] = {
	...
	AREA(1, sl_area_1),
		...
		OBJECT(MODEL_CUSTOM_DOOR_C, -15200, -4700, 6900, 0, -180, 0, 0x00D00000, bhvDoorWarp),
		OBJECT(MODEL_CUSTOM_DOOR_C, -2600, 1300, -14100, -2, -90, 2, 0x00D10000, bhvDoorWarp),
		OBJECT(MODEL_CUSTOM_DOOR_C, -14750, 8970, 11340, 0, -100, 0, 0x00D10000, bhvDoorWarp),
		OBJECT(MODEL_CUSTOM_DOOR_C, -13020, 3143, -2140, 0, 168, 0, 0x00D20000, bhvDoorWarp),
		OBJECT(MODEL_CUSTOM_DOOR_C, 17950, 8210, -9154, 0, -37, 0, 0x00D30000, bhvDoorWarp),
		...
		OBJECT(MODEL_CUSTOM_DOOR_C, 2200, -3800, -10700, 0, 90, 0, 0x00DC0000, bhvDoorWarp),
		OBJECT(MODEL_CUSTOM_DOOR_C, 11800, -1400, -3300, 0, 0, 0, 0x00DD0000, bhvDoorWarp),
		OBJECT(MODEL_CUSTOM_DOOR_C, 14400, 3100, 13500, 0, -90, 0, 0x00DE0000, bhvDoorWarp),
		OBJECT(MODEL_CUSTOM_DOOR_C, -2500, -6400, 13500, 0, -90, 0, 0x00DF0000, bhvDoorWarp),
