...
const GeoLayout sl_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, sl_dl_Test_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_ALPHA, sl_dl_Test_mesh_layer_4),
		GEO_DISPLAY_LIST(LAYER_TRANSPARENT, sl_dl_Test_mesh_layer_5),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
