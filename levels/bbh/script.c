...
const LevelScript level_bbh_entry[] = {
	...
	AREA(1, bbh_area_1),
		...
		OBJECT(MODEL_NONE, 0, 0, 0, 0, 0, 0, 0x00BA0000, bhvSpinAirborneWarp),
		OBJECT(MODEL_NONE, 0, 0, 0, 0, 0, 0, 0x00BB0000, bhvSpinAirborneWarp),
		OBJECT(MODEL_NONE, 0, 0, 0, 0, 0, 0, 0x00BB0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, 0, 0, 1082, -10280),
		OBJECT(MODEL_NONE, 0, 1082, -10280, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		OBJECT(MODEL_NONE, 0, 0, 0, 0, 0, 0, 0x00CA0000, bhvWarp),
		OBJECT(MODEL_NONE, 0, 0, 0, 0, 0, 0, 0x00CB0000, bhvWarp),
		OBJECT(MODEL_NONE, 0, 0, 0, 0, 0, 0, 0x00CB0000, bhvWarp),
