...
const LevelScript level_bbh_entry[] = {
	...
	AREA(1, bbh_area_1),
		...
		OBJECT(MODEL_NONE, 0, 1582, 10280, 0, -180, 0, 0x00BA0000, bhvFadingWarp),
		...
		MARIO_POS(0x01, -180, 0, 1082, 10280),
		OBJECT(MODEL_NONE, -1400, 82, 8900, 0, -180, 0, 0x00400000, bhvPoleGrabbing),
		OBJECT(MODEL_NONE, 0, 1082, 10280, 0, -180, 0, 0x000A0000, bhvSpinAirborneWarp),
		OBJECT(MODEL_NONE, 6900, -1538, 10980, 0, -180, 0, 0x10CA0000, bhvWarp),
		OBJECT(MODEL_NONE, 11900, -4138, -1220, 0, -180, 0, 0x10CB0000, bhvWarp),
		OBJECT(MODEL_NONE, -7200, -3338, -7620, 0, -180, 0, 0x10CC0000, bhvWarp),
		OBJECT(MODEL_NONE, -11700, -8338, 4880, 0, -180, 0, 0x10CD0000, bhvWarp),
