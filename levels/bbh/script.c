...
const LevelScript level_bbh_entry[] = {
	...
	AREA(1, bbh_area_1),
		...
		OBJECT(MODEL_NONE, 8900, -4600, 200, 0, 0, 0, 0x00680000, bhvPoleGrabbing),
		OBJECT(MODEL_NONE, 5800, 2200, 5700, 0, 0, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_NONE, 7800, -3300, 2800, 0, 0, 0, 0x00680000, bhvPoleGrabbing),
		OBJECT(MODEL_NONE, 5800, 900, 5700, 0, 0, 0, 0x00680000, bhvPoleGrabbing),
