...
void init_mario_from_save_file(void) {
    ...
    gMarioState->numStars = save_file_get_total_blue_drop_count(gCurrSaveFileNum - 1, COURSE_MIN - 1, COURSE_MAX - 1);
    gMarioState->numRedDrops = save_file_get_total_red_drop_count(gCurrSaveFileNum - 1, COURSE_MIN - 1, COURSE_MAX - 1);
