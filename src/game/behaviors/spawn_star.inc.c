...
void bhv_collect_star_init(void) {
    ...
    u8 currentLevelStarFlags = save_file_get_star_flags((gCurrSaveFileNum - 1), COURSE_NUM_TO_INDEX((u8) starId / 7));
    if (currentLevelStarFlags & (1 << ((u8) starId % 7))) {
#else
...
struct Object *spawn_star(struct Object *starObj, f32 x, f32 y, f32 z) {
    ...
    starObj = spawn_object_abs_with_rot(o, 0, MODEL_DREAM_DROP_BLUE, bhvStarSpawnCoordinates, o->oPosX, o->oPosY, o->oPosZ, 0, 0, 0);
...
void bhv_hidden_red_coin_star_init(void) {
    ...
    if (numRedCoinsRemaining == 0) {
        ...
        starObj = spawn_object_abs_with_rot(o, 0, MODEL_DREAM_DROP_BLUE, bhvStar, o->oPosX, o->oPosY, o->oPosZ, 0, 0, 0);
        starObj->oBehParams = o->oBehParams;
