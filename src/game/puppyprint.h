...
extern void print_small_text(s32 x, s32 y, const char *str, s32 align, s32 amount, u8 font, u8 glyphToChar);
...
extern s32  get_text_width(const char *str, s32 font, u8 glyphToChar);
extern void prepare_blank_box(void);
extern void finish_blank_box(void);
